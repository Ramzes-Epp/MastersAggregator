...
internal class MasterEditorViewModel : ViewModelBase
{
    ...
    public void Commit()
    {
        var type = _Master.GetType();
        //если внесли изменения в форме - записываем в _Master
        foreach (var (property_name, value) in _Values)
        {
            ...
            property.SetValue(_Master, value);
